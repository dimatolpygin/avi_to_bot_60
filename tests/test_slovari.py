...
# Заказчик расширил ассортимент в Google-таблице (18.09): к прежним 13 семействам
# добавились обливные устройства, плинтус, огнезащитная плита, пульт управления,
# сетка для камней и форточки — все 19 проверены сухим прогоном синка.
SEMEYSTVA_KATALOGA = {
    "вагонка", "полок", "дверь", "печь", "камень", "наличник", "брус",
    "рейка", "фольга", "плитка", "кирпич", "короб", "спил",
    "плинтус", "форточка", "обливное устройство", "сетка", "пульт управления",
    "плита",
}
