...
# Ответственные по аккаунту для раздачи 50/50. Список из ОДНОГО id → все лиды
# аккаунта идут на него (без круга), см. vybrat_menedzhera (len==1).
MENEDZHERY: dict[str, tuple[int, ...]] = {
    "sbsauna": (6783360, 1356618),          # Тейхриб, Гусев
    "sbsauna_deshman": (659847,),           # только Денис Раневский (решение заказчика 24.09)
